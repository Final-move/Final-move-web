  ...
  return (
    <PageContainer className="homeNews-section">
      <section className="main-news">
        ...
        provident obcaecati illo deserunt maxime sunt atque porro? Cumque rem
        odio laboriosam reiciendis adipisci facilis eligendi quasi nihil, illo
        placeat, cum, recusandae officiis ducimus vel quidem ipsa earum
